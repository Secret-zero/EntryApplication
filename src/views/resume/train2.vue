      ...
      <div class='relations'>
        <ul>
          <li>
            ...
            <div class='li-right v-flex' @click='opendateTimePicker(index, "dateTimePopup")'>
              <input type="text" placeholder="请选择" readonly v-model='item.startDate'>
              <i class='iconfont icon-iconfontyoujiantou'></i>
            </div>
          </li>
          <li>
            <div class='name'>至年月</div>
            <div class='li-right v-flex' @click='opendateTimePicker(index, "dateTimePopup2")'>
              <input type="text" placeholder="请选择" readonly v-model='item.endDate'>
              <i class='iconfont icon-iconfontyoujiantou'></i>
            </div>
          </li>
          <li>
