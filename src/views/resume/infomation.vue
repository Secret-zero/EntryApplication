  ...
  <div class='wrap'>
      ...
      <input data-v-67bd53cf="" type="file"  id="file-input" style="display: none;" multiple  accept="image/">
			...
			<div class='phontBox'>
				...
				<img class='id-card' v-if="photo1" :src='photo1' @click="addPic('photo1')">
				<img class='id-card' v-if="!photo2" src='../../assets/images/idCard2.jpg' @click="addPic('photo2')" />
				<img class='id-card' v-else :src='photo2' @click="addPic('photo2')">
			</div>
			<div class='upload'>自拍证件照</div>
			<div class='phontBox'>
				<img src='../../assets/images/person.png' v-if='!photo3' @click="addPic('photo3')">
			...
			<div class='infoList'>
				<ul>
					<li>
						...
						<div class='liRight'>
							<input type="text" placeholder="请选择" v-model='form.FDutyName' readonly required oninvalid="setCustomValidity('请填写应聘职务')" oninput="setCustomValidity('')">
						</div>
					</li>
					<!-- <li>
						<div class='li-left'>
					...
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.Fname' required oninvalid="setCustomValidity('请填写姓名')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							出生年月*
						...
						<div class='li-right v-flex' @click='opendateTimePicker11'>
							<input type="text" placeholder="请选择" readonly v-model='form.FBirthday' required oninvalid="setCustomValidity('请填写出生年月')" oninput="setCustomValidity('')">
					...
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.FNationID' required oninvalid="setCustomValidity('请填写民族')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							性别*
						...
						<div class='li-right v-flex' @click='popupVisible = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FsexID' required oninvalid="setCustomValidity('请填写性别')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li>
						...
						<div class='li-right v-flex' @click='popupVisible2 = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FmarriageID' required oninvalid="setCustomValidity('请填写婚姻状况')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
						<li>
						...
						<div class='li-right v-flex' @click='popupVisible6 = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FNativePlaceID' required oninvalid="setCustomValidity('请填写籍贯')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<!-- <li>
					...
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.Faddreess' required oninvalid="setCustomValidity('请填写户籍所在')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							文化程度*
						...
						<div class='li-right v-flex' @click='popupVisible3 = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FDegreeID' required oninvalid="setCustomValidity('请填写文化程度')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.Fcertificate' required oninvalid="setCustomValidity('请填写持有证件')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							招聘来源*
						...
						<div class='li-right v-flex' @click='popupVisible4 = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FenrolID' required oninvalid="setCustomValidity('请填写招聘来源')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.FID' required oninvalid="setCustomValidity('请填写身份证号')" oninput="setCustomValidity('')">
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						<div class='li-left'>
							职称（没有填无）*
						</div>
						<input type="text" placeholder="请填写" v-model='form.FtechnicalPost' required oninvalid="setCustomValidity('请填写职称')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							现在住址*
						</div>
						<input type="text" placeholder="请填写" v-model='form.FNowAddreess' required oninvalid="setCustomValidity('请填写现在住址')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							预计到岗时间*
						...
						<div class='li-right v-flex' @click='opendateTimePicker12'>
							<input type="text" placeholder="请选择" readonly v-model='form.FBeginHireDate' required oninvalid="setCustomValidity('请填写预计到岗时间')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li>
						...
						<div class='li-right v-flex' @click='opendateTimePicker13'>
							<input type="text" placeholder="请选择" readonly v-model='form.FFutureWorkdate' required oninvalid="setCustomValidity('请填写预计务工时间')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li>
						...
						<input type="text" placeholder="请填写" v-model='form.FExigencePhone' required oninvalid="setCustomValidity('请填写紧急联络人及电话')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
							本人电话*
						</div>
						<input type="text" placeholder="请填写" v-model='form.FPhone' required oninvalid="setCustomValidity('请填写本人电话')" oninput="setCustomValidity('')">
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						<div class='li-left'>
						专业*
						</div>
						<input type="text" placeholder="请填写" v-model='form.Fspecialty' required oninvalid="setCustomValidity('请填写专业')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
						政治面貌*
						...
						<div class='li-right v-flex' @click='popupVisible5 = true'>
							<input type="text" placeholder="请选择" readonly v-model='form.FpoliticsFace' required oninvalid="setCustomValidity('请填写政治面貌')" oninput="setCustomValidity('')">
							<i class='iconfont icon-iconfontyoujiantou'></i>
						</div>
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
					...
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						...
						<input type="text" placeholder="请填写" v-model='form.FEmpGroupID'>
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						<div class='li-left'>
						身高（厘米）*
						</div>
						<input type="text" placeholder="请填写" v-model='form.Fstature' required oninvalid="setCustomValidity('请填写身高')" oninput="setCustomValidity('')">
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						<div class='li-left'>
						体重（公斤）*
						</div>
						<input type="text" placeholder="请填写" v-model='form.Favoirdupois' required oninvalid="setCustomValidity('请填写体重')" oninput="setCustomValidity('')">
					</li>
					<li v-if='$route.query.type == 2 || $route.query.type == 3'>
						<div class='li-left'>
						预计工作年限*
						</div>
						<input type="text" placeholder="请填写" required oninvalid="setCustomValidity('请填写预计工作年限')" oninput="setCustomValidity('')">
					</li>
					<li>
						<div class='li-left'>
						邮政编码
						</div>
						<input type="text" placeholder="请填写" v-model='form.FpostalCode'>
					</li>
					<li>
						<div class='li-left'>
						介绍人姓名/工号（没有填无）*
						</div>
						<input type="text" placeholder="请填写" v-model='form.FIntroducer' required oninvalid="setCustomValidity('介绍人姓名/工号')" oninput="setCustomValidity('')">
					</li>
			...
			<input type="submit" class='mint-button mtbutton mint-button--default mint-button--normal' >
		</form>
  </div>
</template>

<script>
import { Button, Popup, Picker, DatetimePicker,Toast } from 'mint-ui';
...
const dateThree = date.getFullYear() + 3 + '-' + ((date.getMonth() + 1) < 10 ? '0' + (date.getMonth() + 1) : (date.getMonth() + 1) )+ '-' + (date.getDate())
export default {
  data() { 
    return {
      ...
      slots3: [
        {
          flex: 1,
          values: ['小学','初中','高中', '中专', '大专', '本科', '硕士', '研究生'],
          className: 'slot1',
          textAlign: 'center'
        }
      ],
      slots4: [
        {
          flex: 1,
          values: ['外部招聘','推荐','内部晋升', '员工介绍', '老员工返厂', '校园招聘', '网络招聘（58同城）', '网络招聘（鞋业人才网）', '网络招聘（温州人力资源网）', '网络招聘（前程无忧）'],
          className: 'slot1',
          textAlign: 'center'
        }
      ],
  ...
  mounted() {
    if (this.main) {
      this.form = this.main
      this.photo1 = this.form.FIDCardFront ? 'data:image/jpeg;base64,' + this.form.FIDCardFront : ''
      this.photo2 = this.form.FIDCardBack ? 'data:image/jpeg;base64,' + this.form.FIDCardBack : ''
			this.photo3 = this.form.FUserAvatar ? 'data:image/jpeg;base64,' + this.form.FUserAvatar : ''
  ...
  methods: {
      ...
      console.info(this.slots6)
      
    },
    async getCardInfo() {
      this.$store.commit('updateLoadingStatus', {isLoading: true})
      let data = await Idcard({picture: this.photo1.replace('data:image/jpeg;base64,', ''), id_card_side: 'front'})
      ...
      this.form.FIDCardFront = this.photo1.replace('data:image/jpeg;base64,', '')
      this.$set(this.form, 'Fname', data.words_result.姓名.words || this.form.Fname)
      this.$set(this.form, 'FNationID', data.words_result.民族.words || this.form.FNationID)
      this.$set(this.form, 'FID', data.words_result.公民身份号码.words || this.form.FID)
      this.$set(this.form, 'FsexID', data.words_result.性别.words || this.form.FsexID)
      this.$set(this.form, 'Faddreess', data.words_result.住址.words || this.form.Faddreess)
      let birthday = data.words_result.出生.words ? data.words_result.出生.words : '';      
      birthday =  birthday.slice(0, 4) + '-' + birthday.slice(4, 6)+ '-' + birthday.slice(6, 8)
      this.$set(this.form, 'FBirthday', birthday)
    },
    async getCardInfo2() {
      this.$store.commit('updateLoadingStatus', {isLoading: true})
      let data = await Idcard({picture: this.photo2.replace('data:image/jpeg;base64,', ''), id_card_side: 'back'})
      this.$store.commit('updateLoadingStatus', {isLoading: false})
      ...
      if(data.image_status != 'normal'){
        ...
        Toast({message: '证件识别成功',duration: 1000});
			...
			this.form.FIDCardBack = this.photo2.replace('data:image/jpeg;base64,', '')
			
      this.form.FUserLifeBeginDate = this.dateFormat(data.words_result.签发日期.words) ? this.dateFormat(data.words_result.签发日期.words) : this.form.FUserLifeBeginDate
      this.form.FUserLifeEndDate = this.dateFormat(data.words_result.失效日期.words) ? this.dateFormat(data.words_result.失效日期.words) : this.form.FUserLifeEndDate
			this.form.FPoliceStation = data.words_result.签发机关.words ? data.words_result.签发机关.words: this.form.FPoliceStation
    },
    addPic(val) {
      this.type = val
    ...
    async imgChange() {
      ...
      for (const textPromise of fileList) {
        ...
        if (this.type === 'photo1') {
          ...
          this.form.FUserAvatar = this.photo3.replace('data:image/jpeg;base64,', '')
        }
			}
    ...
    confirm() {
      ...
      if (!_FUserLifeBeginDate)
        this.form.FUserLifeBeginDate = _FUserLifeBeginDate.slice(0, 4) + '-' + _FUserLifeBeginDate.slice(4, 6)+ '-' + _FUserLifeBeginDate.slice(6, 8);  
      
      //证件签发结束日期
      let _FUserLifeEndDate = this.form.FUserLifeEndDate;
      if(!_FUserLifeEndDate)
        this.form.FUserLifeEndDate = _FUserLifeEndDate.slice(0, 4) + '-' + _FUserLifeEndDate.slice(4, 6)+ '-' + _FUserLifeEndDate.slice(6, 8);      
      
			this.saveSession('main', this.form)
			this.$router.push({path: '/ctalog',query:{type:this.$route.query.type}})
      //this.$router.go(-1)
		},
    ...
    popupBtn(value) {
      ...
      if (value === 'cancel') {
        ...
        let fullDate1 = date.getFullYear() + '-' + (date.getMonth() + 1 < 10 ? '0' + (date.getMonth()+ 1) : date.getMonth() + 1) + '-' + (date.getDate() < 10 ? '0' + date.getDate() : date.getDate())
        let fullDate2 = date.getFullYear() + 3 + '-' + (date.getMonth() + 1 < 10 ? '0' + (date.getMonth()+ 1) : date.getMonth() + 1) + '-' + (date.getDate() < 10 ? '0' + date.getDate() : date.getDate())
